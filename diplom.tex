...
\begin{document}
    ...
    \chapter{Related Work} % TODO: filter papers by number of citations and conferences
    \begin{itemize}
        ...
        \item \textbf{\citetitle{ancajas14fortnocs}}
            \begin{itemize}
                ...
                \item Fort-NoCs: 3-layer security mechanism (hardware level protection)
                    \begin{itemize}
                        \item Lower layer data scrambling
                        \item Middle layer packet certification
                        \item Top layer node obfuscation
                    \end{itemize}
