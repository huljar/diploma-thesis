...
As a deterministic strategy, dimension order routing is used. On the dynamic side, \gls{dsr} and \gls{romm} routing are explored. The properties and
details of these strategies are presented in depth in Section (insert ref here).% TODO: replace dsr with new term
...
process is elaborated in Chapter \ref{ch:evaluation}. % TODO: replace all "crypto units" with "crypto(graphic) modules"
