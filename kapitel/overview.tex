...
control} \cite[2]{moriam18activeattackers}, eliminating the attack vector of third party \gls{ip}. This model is visualized in Figure (insert vref
here).
% TODO: figure with red routers, green rest, maybe small bars at the trust boundaries
