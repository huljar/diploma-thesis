...
\citeauthor{gebotys03securityframework} \cite{gebotys03securityframework} (see also Section \ref{subsec:securityzones}).}.
...
first two, both uncoded and network coded variants are implemented. For the latter, only a network coded variant is feasible. Since the authentication
scheme relies on the implications of network coding, no uncoded counterpart exists. (insert ref to protocol section here)
