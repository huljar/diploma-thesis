...
\begin{table}
    ...
    \end{tabulary}
    \caption[Input parameters for the number of crypto modules experiment]{The input parameters for the simulator in the experiment to determine the
...
\begin{table}
    ...
    \end{tabulary}
    \caption[Input parameters for the port queue sizes experiment]{The input parameters for the simulator in the experiment to determine the size of the
    routers' port queues.}
...
\begin{table}
    ...
    \begin{tabulary}{\textwidth}{C|C|C||C}
        ...
        \multirow{2}{=}{\num{99120} \gls{ge}} & \multirow{2}{=}{8496 \gls{ge}} & \multirow{2}{=}{372.5 B} & \num{107616} \gls{ge} \\
                                              & & & 372.5 B
    \end{tabulary}
