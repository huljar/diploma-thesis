...
the router workload distributions over the network were investigated as well (see below).
...
Once again, DM brings an advantage only for the network coded version. This result matches the expectation (cf. Section
\ref{subsec:routingclassification}) since only the network coded protocols benefit from partially circumventing malicious routers.

\subsection{Increased ARQ limit}
DOR as routing strategy to preserve comparability with the results from Section \ref{subsec:protocolvariantseval}.
