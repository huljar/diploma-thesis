...
\end{table}
% TODO: notation for integer/real intervals
...
\begin{table}
    ...
    \end{tabulary}
    \caption[Input parameters for router queue sizes experiment]{The input parameters for the simulator in the experiment to determine the size of the
    routers' port queues.}
