...
such cases, the receiver would issue an \gls{arq} as usual, but include a list of \gls{gev}/mode pairs of those flits that have already arrived (i.e.,
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{protocol-flit-distributions-indauth}
    \caption[short]{long}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{single-timeout-indauth-uc}
    \caption[short]{long}
