...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{verification-fail-indauth-uc}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{timeout-indauth-nc}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{verification-fail-intauth-nc}
