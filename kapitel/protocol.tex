...
\[
    ...
    \end{bmatrix}
\]
using Gaussian elimination until the matrix is in reduced row echelon form, i.e., of the following structure:
\[
    \begin{bmatrix}
        1 & & 0 & p_{0,\,0} & \cdots & p_{0,\,P-1} \\
        & \ddots & & \vdots & \ddots & \vdots \\
...
header fields are simply copied over from one of the combinations as they have not changed.
