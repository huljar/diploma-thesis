...
A strong emphasis of this thesis lies on the exploration of the usage of multiple paths. Recalling that the topology of the \gls{noc} is a 2D mesh,
there is a multitude of possible paths to reach a destination from a particular source node.

An overview of the explored routing strategies and their characteristics is given in Figure \vref{fig:routingcharacteristics}.

\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{routing-characteristics}
    \caption[Routing strategies by category]{Different routing strategies categorized by their characteristics.}
