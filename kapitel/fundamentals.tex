...
Traditionally: acknowledgements for each arrived flit/packet. Here: no acknowledgements to save network bandwidth, but send retransmission requests
when a flit does not arrive. Those are referred to as ARQs throughout this thesis.
