...
In recent research, many different attack vectors have been explored, and a variety of countermeasures has been proposed to mitigate
attacks. The remainder of this section will explain them in detail.
...
\citeauthor{sethumadhavan15trustworthyhardware} \cite{sethumadhavan15trustworthyhardware} analyze the problem of building systems from untrusted
...
integrating malicious components. The methods in both works are not specific to \gls{noc} architectures, but are applicable for them nonetheless.
...
The approach of the authors is to detect any flit tampering right after they leave a router. To achieve this, an error control code and dynamic flit
...
Another popular approach is to divide the \gls{noc} into security zones.
