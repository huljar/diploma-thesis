...
standard cryptographic algorithms such as \gls{aes} are usually not efficient enough for this task \cite[1]{bogdanov07present}. With the tight area
and power consumption constraints in \glspl{mpsoc} (cf. Section \ref{sec:networkonchipfun}), novel designs that tackle this problem have become essential
for the implementation of cryptographic protection measures.

In the work directly preceding this thesis, lightweight cryptographic algorithms were thoroughly explored \cite{harttung17lightweightcrypto}. Such
algorithms are
