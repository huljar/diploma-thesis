...
\newglossaryentry{ramm}{
    name = {RAMM},
    description = {Randomized Adaptive Multi-phase Minimal}
}
\newglossaryentry{dor}{
    name = {DOR},
    description = {Dimension Order Routing}
}
\newglossaryentry{dm}{
    name = {DM},
...
\newglossaryentry{iwa}{
    name = {IWA},
    description = {Interwoven Authentication}
}
\newglossaryentry{fga}{
    name = {FGA},
    description = {Full-Generation Authentication}
}
\newglossaryentry{ge}{
    name = {GE},
    description = {Gate Equivalents}
}
